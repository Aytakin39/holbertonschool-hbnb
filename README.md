...
It includes: User Place Review Amenity

In this layer:

Business rules are applied Data is validated System logic is handled
...
Save data to the database Retrieve data when needed
...
Receives requests Sends them to the correct component Hides internal complexity

Benefits Provides one single entry point Makes the system easier to understand Improves code organization Reduces dependency between layers
